...
#python3 $BIN_PATH/map_reads.py -settings ./data/settings.txt -samples tube_1
python3 $BIN_PATH/map_reads.py -settings ./data/settings.txt -samples tube_2
python3 $BIN_PATH/map_reads.py -settings ./data/settings.txt -samples tube_3
